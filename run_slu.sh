...
unzip ./src/slu/rnn-nlu-intent/model_intent.zip -d ./src/slu/rnn-nlu-intent/
unzip ./src/slu/rnn-nlu-tagging/model_tagging.zip -d ./src/slu/rnn-nlu-tagging/

# generate dstc5_test_slu file list
python src/slu/check_test.py $1
...
# generate
python ./src/slu/generate_testResult_slu.py --trainset dstc5_train --testset dstc5_test_slu --dataroot $1 --testIntent ./src/slu/predict-sep/intent.txt  --testSlot ./src/slu/predict-sep/tagging.txt --predictF ./src/slu/predict-sep --outfile $2 --roletype GUIDE
