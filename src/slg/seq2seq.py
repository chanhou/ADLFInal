...
def sequence_loss_by_example(logits, targets, weights,
                             ...
                             softmax_loss_function=None, name="sequence_loss_by_example"):
  ...
  # with ops.name_scope(name, logits + targets + weights):
...
def sequence_loss(logits, targets, weights,
                  ...
                  softmax_loss_function=None, name="sequence_loss"):
...
def model_with_buckets(encoder_inputs, decoder_inputs, targets, weights,
  ...
  losses = []
  outputs = []
  # with tf.name_scope(name, values=all_inputs):
  with ops.name_scope(name):
