...
testF = 'test'
os.system('rm '+'./src/slu/rnn-nlu-tagging/data/slu/'+testF+'/*')
ftest = open('./src/slu/rnn-nlu-tagging/data/slu/'+testF+'/'+testF+'.seq.in','w')
fhyp = open('./src/slu/predict-sep/hyp','r')
