...
# http://stackoverflow.com/questions/35400065/multilabel-text-classification-using-tensorflow
...
x_train, x_dev, x_test, y_train, y_dev, mlb  = data_helpers.load_data_and_labels('train')
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        cnn = TextCNN(
            ...
            num_classes= len(mlb.classes_), #y_train.shape[1],
